...
var _id_Post = function Post(props) {
  return external_react_default.a.createElement(Layout["a" /* default */], null, external_react_default.a.createElement("h1", null, props.show.name), external_react_default.a.createElement("p", null, props.show.summary.replace(/<[/]?p>/g, '')), external_react_default.a.createElement("img", {
    src: props.show.image.medium
  }));
};

_id_Post.getInitialProps =
/*#__PURE__*/
function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            id = context.query.id;
            _context.next = 3;
            return external_isomorphic_unfetch_default()("https://api.tvmaze.com/shows/".concat(id));
